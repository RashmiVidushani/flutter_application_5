                ...
                child: Row(
                  ...
                  children: <Widget>[
                    GestureDetector(
                      ...
                      child: Row(
                        children: <Widget>[
                          Icon(Icons.favorite,size: 18,color: widget.myData.myLikeList != null && widget.myData.myLikeList.contains(widget.data['postID']) ? Colors.redAccent : Colors.black),
                          Padding(
                    ...
                    GestureDetector(
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          Padding(
                            padding: const EdgeInsets.only(left:8.0),
                            child: Text('Discuss ( ${widget.commentCount} )',style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold),),
                          ),
                        ],
                      ),
                    ),
